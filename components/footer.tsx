    ...
    >
      <nav>
        <ul className="flex gap-6">
          <li>
            <a href='https://www.facebook.com/Jakkajee777'>
          ...
          <li>
            <a href='https://twitter.com/AomoiThetan'>
          ...
          <li>
            <a href='https://github.com/MochaDecoder'>
      ...
      <p className="text-sm text-slate-500">&copy; 2023 Passakorn Ketvan. All rights reserved.</p>
    </footer>
  );
}